...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET,"/api/tech/loadCache").permitAll()
                .antMatchers(HttpMethod.GET,"/api/workManagement/**").permitAll()
                .antMatchers("/api/workManagement/extended").permitAll()
                .antMatchers("/api/workManagement/filterOptions").permitAll()
                .antMatchers("/api/workManagement/allWorks").permitAll()
                .antMatchers("/api/information").permitAll()
                .antMatchers("/api/partnerManagement").permitAll()
